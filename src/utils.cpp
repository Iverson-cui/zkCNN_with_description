...
// check if (x,y) is in the matrix of size (nx, ny)
...
/**
 * Initialization function for all type of layers
 * @param: circuit is the layer to be initialized
 * @param: size is the number of outputs this layer produces
 * @param: ty is the type of this layer, like input or conv etc.
 */
...
/**
 * x,y,z is the coordinates
 * n and m is the length of 2nd and 3rd dimensions
 * @return (x*n + y)*m + z
 */
...
/**
 * convert a tensor index to linear index
 * compared to cubIdx, it contains 4 dimensions
 */
